...
export interface ShilmanFormResponse {
  success: boolean;
}

export interface ShilmanFormValues {
  email: string;
  password: string;
}

interface FormValues extends ShilmanFormValues {
    ...
    <Wrapper>
      ...
      <Content>
        {state.transactionSuccess && !state.transactionFailure && (
          <Presentation>
            <p>
              Everything is perfect, your account has been made and we sould probably get you
              started
            </p>
        ...
        {state.transactionFailure && !state.transactionSuccess && (
          <Presentation>
            <p>What a fucking shit show, this API is not working</p>
            <p>
